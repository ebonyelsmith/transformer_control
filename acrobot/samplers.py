...
class CartPoleSampler2(DataSampler):
    ...
    def generate_xs_dataset(self, n_points, bsize, cartmass=torch.tensor([2]), polemass=torch.tensor([0.2]), polelength=torch.tensor([0.5]), device='cuda:1'):
        """
        ...
        T, xs_dataset, control_values, control_modes = checking_cartpole(X0, total_time, m_c=cartmass, m_1=polemass, l_1=polelength, method='rk4', dt=0.025, device=device)
