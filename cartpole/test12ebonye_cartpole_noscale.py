...
# import workCon
import workCon_cartpole_aigym as workCon
# import os
...
import random
import math
import generate_dataset_cartpole_ebonye
...
Num_of_pendulums = 100 #200 #1 #10 #20 #40 #10
...
def main(model_checkpoint_step):
    ...
    return cartmasses, polemasses, polelenghs, phase_data, controls_data, data_and_controls, pends, folder_name

for model_checkpoint_step in model_checkpoint_steps:
    print(f"\n{'='*80}")
    ...
    try:
        ...
        cartmasses, polemasses, polelenghs, phase_data, controls_data, data_and_controls, pends, folder_name = results
