...
def make_train_data(args):
    ...
    for i in pbar:
        ...
        if i < args.training.train_steps:
            ...
            save_pickle((xs_cpu, control_values_cpu, LINK_LENGTH_1, LINK_LENGTH_2, LINK_MASS_1, LINK_MASS_2, true_xs_cpu), pickle_path)
            append_to_dataset_logger(i-args.training.train_steps, LINK_LENGTH_1, LINK_LENGTH_2, LINK_MASS_1, LINK_MASS_2, xs_cpu.shape, test_logger)
            ...
            # pass
            LINK_LENGTH_1, LINK_LENGTH_2, LINK_MASS_1, LINK_MASS_2 = get_valid_masses_and_lengths_uniform(size=bsize, LINK_LENGTH_1_lowerbound=1.0, LINK_LENGTH_1_upperbound=1.5,
            ...
            pickle_file = f'batch_test_{i-args.training.train_steps-args.training.test_pendulums}.pkl'
            pickle_path = os.path.join(test_data_dir_outofdistr, pickle_file)
